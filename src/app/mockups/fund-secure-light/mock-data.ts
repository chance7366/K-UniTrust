...
export const MOCK_RISK_TIERS = [
  { tier: "고위험 (<80%)", count: 12, color: "#F43F5E" },
  { tier: "위험 (80~100%)", count: 35, color: "#F59E0B" },
  { tier: "양호 (100~120%)", count: 98, color: "#6366F1" },
  { tier: "여유 (≥120%)", count: 167, color: "#10B981" },
];
...
export const MOCK_HISTOGRAM = [
  ...
  { bin: "60~80%", count: 23 },
  { bin: "80~100%", count: 35 },
  { bin: "100~120%", count: 52 },
  { bin: "120~150%", count: 68 },
  { bin: "150~200%", count: 72 },
  { bin: "≥200%", count: 34 },
];
...
export const MOCK_RISK_SCHOOLS = [
  { name: "○○대학교", region: "경남", totalFunds: 892, tuition: 810, rate: 72.4, tier: "고위험" },
  { name: "△△대학교", region: "전남", totalFunds: 654, tuition: 720, rate: 78.2, tier: "고위험" },
  { name: "□□대학교", region: "강원", totalFunds: 1_120, tuition: 1_180, rate: 88.6, tier: "위험" },
  { name: "◇◇대학교", region: "경북", totalFunds: 980, tuition: 1_050, rate: 93.4, tier: "위험" },
  { name: "☆☆대학교", region: "인천", totalFunds: 1_340, tuition: 1_420, rate: 96.8, tier: "위험" },
];
