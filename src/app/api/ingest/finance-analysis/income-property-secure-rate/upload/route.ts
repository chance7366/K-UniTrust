...
import { ingestIncomePropertySecureRateUpload } from "@/lib/ingest/income-property-secure-rate-upload";
...
export async function POST(request: Request) {
  ...
  try {
    ...
    const result = await ingestIncomePropertySecureRateUpload(buffer, file.name);
