...
import { ingestTuitionDependencyRateUpload } from "@/lib/ingest/tuition-dependency-rate-upload";
...
export async function POST(request: Request) {
  ...
  try {
    ...
    const result = await ingestTuitionDependencyRateUpload(buffer, file.name);
