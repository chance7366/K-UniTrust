...
import { listFpReportsForYear } from "@/lib/competitiveness-analysis/financial-projection/report/fp-report-store";
...
export async function GET(
  ...
  try {
    ...
    const reports = await listFpReportsForYear(analysisYear);
