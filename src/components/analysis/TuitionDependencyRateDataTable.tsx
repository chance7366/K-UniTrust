...
const TABLE_METRIC_COLUMN_COUNT = 5;
...
export function TuitionDependencyRateDataTable({
            ...
            {visibleRows.map((row, visibleIndex) => {
              ...
              >
                ...
                <td className={metricCellClass}>
                  ...
                  {fmtMillionWon(row.schoolOperatingRevenue)}
                ...
                <td className={`${metricCellClass} ${FDB_TABLE_COLOR.ratePrimary}`}>
                  ...
                  {fmtPercent(row.tuitionDependencyRate)}
