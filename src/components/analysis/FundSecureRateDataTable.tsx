...
const TABLE_METRIC_COLUMN_COUNT = 7;
...
export function FundSecureRateDataTable({ rows }: { rows: FundSecureRateRow[] }) {
            ...
            {visibleRows.map((row, visibleIndex) => {
              ...
              >
                ...
                <td className={metricCellClass}>
                  ...
                  {fmtMillionWon(row.schoolFundsCarryover)}

                </td>

                <td className={metricCellClass}>

                  {fmtMillionWon(row.schoolFundsEndowment)}
