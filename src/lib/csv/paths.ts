...
export const CSV_FILES = {
  ...
  univMapForeignStudentsUndergrad: "univ_map_foreign_students_undergrad.csv",
  univMapForeignStudentsGrad: "univ_map_foreign_students_grad.csv",
  univMapForeignDropoutUndergrad: "univ_map_foreign_dropout_undergrad.csv",
  univMapForeignDropoutGrad: "univ_map_foreign_dropout_grad.csv",
