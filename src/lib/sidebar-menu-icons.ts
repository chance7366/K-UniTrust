...
const TAB_ICONS: Record<string, SidebarIconConfig> = {
  ...
  "tuition-fund": { icon: Landmark },
  "tuition-fund-expense": { icon: Landmark },
  "tuition-balance": { icon: Building2 },
  "tuition-operation": { icon: Database },
  "non-tuition-fund": { icon: Landmark },
  "non-tuition-fund-expense": { icon: Landmark },
  "non-tuition-balance": { icon: Building2 },
  "non-tuition-operation": { icon: Database },
